...
func buildCodeWhispererRequest(c *gin.Context, anthropicReq types.AnthropicRequest, tokenInfo types.TokenInfo, isStream bool) (*http.Request, error) {
	...
	req.Header.Set("x-amz-user-agent", "aws-sdk-js/3.738.0 ua/2.1 os/macos#14.0.0 lang/js md/nodejs#20.16.0 api/codewhispererstreaming#3.738.0")
	req.Header.Set("user-agent", "aws-sdk-js/3.738.0 ua/2.1 os/macos#14.0.0 lang/js md/nodejs#20.16.0 api/codewhispererstreaming#3.738.0")
